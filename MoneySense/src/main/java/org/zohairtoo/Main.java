package org.zohairtoo;

public class Main {
    public static void main(String[] args) {
        System.out.println("Hello, from Zohair!");
        System.out.println("This app is basically for personal use to track personal state and stages of financial aspects throughout a life span");
        ...
        System.out.println("It will gather all sort of Information from the user, but then");
